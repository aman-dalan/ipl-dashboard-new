package com.example.ipldashboardnew.data;
...
public class MatchInput {
    ...
    public String toString() {
        return "MatchInput [id=" + id + ", city=" + city + ", date=" + date + ", season=" + season + ", matchNumber="
                + matchNumber + ", team1=" + team1 + ", team2=" + team2 + ", venue=" + venue + ", tossWinner="
                + tossWinner + ", tossDecision=" + tossDecision + ", superOver=" + superOver + ", winningTeam="
                + winningTeam + ", wonBy=" + wonBy + ", margin=" + margin + ", method=" + method + ", playerOfMatch="
                + playerOfMatch + ", team1Players=" + team1Players + ", team2Players=" + team2Players + ", umpire1="
